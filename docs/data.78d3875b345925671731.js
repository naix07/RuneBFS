...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"jsondata","6":"view"}[chunkId]||chunkId) + "." + {"0":"7321dfca1bd3992eb322","1":"6be0ec5009d5bc21d882","2":"0470e8992ea92ad3cc54","3":"4a83d969cda8bea8d154","4":"926e9c90d08d6e84addb","5":"c4980c3aa38cedcf22da","6":"e692579e135f12c7dbf4"}[chunkId] + ".js";
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAstrolabe", function() { return getAstrolabe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRuneCost", function() { return getRuneCost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRuneResetCost", function() { return getRuneResetCost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRuneDesc", function() { return getRuneDesc; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllRuneDescNameByTypeBranch", function() { return getAllRuneDescNameByTypeBranch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRuneDataById", function() { return getRuneDataById; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPath", function() { return getPath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPathWithWeight", function() { return getPathWithWeight; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getConnectedComponent", function() { return getConnectedComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "init", function() { return init; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDataOutdated", function() { return isDataOutdated; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveLastUpdate", function() { return saveLastUpdate; });
    ...
    return isDataOutdated().then(function (needForceUpdate) {
        ...
        if (!forceInit && !needForceUpdate) {
            ...
            var loaddata = function (key) {
                return __WEBPACK_IMPORTED_MODULE_0_localforage___default.a.getItem(baseKey + key).then(json => {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_localforage___default.a.clear().then(() => {
            var savedata = function (key, jsondata) {
                return __WEBPACK_IMPORTED_MODULE_0_localforage___default.a.setItem(baseKey + key, JSON.stringify(jsondata), function () {
                    console.log("Get data from web. ", key);
                    data[key] = jsondata;
                });
            }
            promises.push(__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 26)).then(jsondata => {
                    return savedata('astrolabe', jsondata);
                }));
            promises.push(__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 27)).then(jsondata => {
                    return savedata('rune', jsondata);
                }));
            promises.push(__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 28)).then(jsondata => {
                    return savedata('runeByTypeBranch', jsondata);
                }));
            promises.push(__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 29)).then(jsondata => {
                    return savedata('runeSpecial', jsondata);
                }));
            promises.push(__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 30)).then(jsondata => {
...
var isDataOutdated = function () {
    return __WEBPACK_IMPORTED_MODULE_0_localforage___default.a.getItem(lastUpdateKey).then(function (data) {
        lastUpdate = data;
        return __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 31)).then(data => {
...
var saveLastUpdate = function () {
    return __WEBPACK_IMPORTED_MODULE_0_localforage___default.a.setItem(lastUpdateKey, lastUpdate)
};
...
var getRuneCost = function (id) {
    return (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.rune, function (p) { return p.Id === parseInt(id); }) || {}).Cost || [];
}
var getRuneResetCost = function (id) {
    return (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.rune, function (p) { return p.Id === parseInt(id); }) || {}).ResetCost || [];
}
var getRuneDesc = function (id, typeBranch) {
    var desc = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.runeByTypeBranch[typeBranch], function (p) { return p.Id === parseInt(id); }) || {};
    if (desc.SpecialDescId) {
        desc.Runetip = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.runeSpecial, function (p) { return p.Id === parseInt(desc.SpecialDescId); });
        if (desc.Runetip) {
            desc.Runetip.Text = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.runeSpecialDesc, function (p) { return p.Id === desc.Runetip.Runetip }).Text;
            desc.Desc = formatRunetip(desc.Runetip);
        }
    }
    else {
        desc.Desc = __WEBPACK_IMPORTED_MODULE_2__ui_js__["a" /* default */].getEquipEffect(desc.Key) + "+" + desc.Value;
    }
    return desc;
}
var getAllRuneDescNameByTypeBranch = function (typeBranch) {
    return __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.chain(data.runeByTypeBranch[typeBranch])
...
var getRuneDataById = function (id) {
    return __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.astrolabe, function (p) { return p.Id === parseInt(id); });
};
...
var getPath = function (runeList, runeId, maxevo) {
    ...
    var bfs = function (runeFrom) {
        ...
        while (queue.length) {
            var v = queue.shift();
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(getRuneLink(v), function (w) {
                if ((__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(data.astrolabe, function (p) { return p.Id === parseInt(w); }) || {}).Evo > maxevo) {
                    return;
                }
                if (!marked[w]) {
                    edgeTo[w] = v;
    ...
    return __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.min(pathList, function (o) { return o.length; });
}
...
var getPathWithWeight = function (runeList, runeId, maxevo, param) {
    ...
    var DijkstraSP = function (s) {
        __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(data.astrolabe, function (o, i) {
            distTo[o.Id] = Infinity;
        });
        distTo[s] = 0;
        pq.push({ id: s, weight: 0 });
        while (pq.length) {
            var min = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.min(pq, "weight");
            pq = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.without(pq, min);
            relax(min.id);
        }
    };
    ...
    var relax = function (v) {
        __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(getRuneLink(v), function (w) {
            ...
            if (distTo[w] > distTo[v] + weight) {
                ...
                edgeTo[w] = v;
                if (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.any(pq, function (o) { return o.id == w })) {
                    __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(pq, function (o) { return o.id == w }).weight = distTo[w];
                }
                else {
...
var getRuneWeight = function (runeId, param) {
    ...
    return __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.reduce(cost, function (memo, item) {
        return memo + item.Count * (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(param, function (o) { return o.id == item.Id }) || { weight: 0 }).weight;
    }, 0);
};
...
var getConnectedComponent = function (runeList) {
    ...
    var dfs = function (v) {
        ...
        id[v] = count;
        __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(getRuneLink(v), function (w) {
            if (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.contains(runeList, w) == false) {
                return;
            }
            if (!marked[w]) {
                dfs(w);
    ...
    __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(runeList, function (s) {
        if (!marked[s]) {
            dfs(s);
            count++;
        }
    ...
    __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(runeList, function (o) {
...
"use strict";
/* unused harmony export supportedLang */
/* unused harmony export getText */
/* unused harmony export getLang */
/* unused harmony export setLang */
/* unused harmony export init */
/* unused harmony export getEquipEffect */
...
var setLang = function (lang) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.any(supportedLang, function (o) { return o.key == lang }) == false) {
        lang = 'zh-CN';
    }
    currentLang = lang;
    localStorage["uilang"] = lang;
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#currentLang').text(__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(supportedLang, function (o) {
        return o.key == lang;
    }).text);
};
var init = function () {
    ...
    switch (currentLang) {
        case "ja-JP": {
            __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 22));
            break;
        }
        case "zh-TW": {
            __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 23));
            break;
        }
        case "en-US": {
            __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 24));
            break;
        }
        case "zh-CN": {
            __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 25));
            break;
        }
    }
};
