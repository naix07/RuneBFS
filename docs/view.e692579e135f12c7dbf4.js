...
var render = function (id, savedata) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.each(astrolabe, function (o, i) {
        ...
        var $rune = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<div>")
            ...
            .attr("data-content",
                ...
                '<li class="list-group-item p-1">' + __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.reduce(cost, function (result, current) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#main').on('inserted.bs.popover', function (e) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.popover').each(function (i, o) {
            var $popover = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(o);
            if (z < parseInt($popover.css('z-index'))) {
                z = parseInt($popover.css('z-index'));
            }
            if ($popover.find('button.close').length < 1) {
                var $closeButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<button type="button" id="close" class="close">&times;</button>');
                $closeButton.click(function () {
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parents(".popover").popover("hide");
                });
                $popover.find('.popover-header').append($closeButton);
            }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.popover:last')
            .css('z-index', z + 1)
